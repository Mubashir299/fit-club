    ...
    <div className="hero">
        ...
        <div className="left-h">
            ...
            <div className="hero-text">
                <div><span className='strok-text'>Shape </span>
                <span>Your</span>
                </div>
                <div>
                ...
                <div className="span">
                    <span>
                    In here we will help you to shap and build your ideal body and live up your
                    life to fullent
                    </span>
                </div>
            </div>
        ...
        <div className="right-h">
            ...
            <div>
            <span>Calories Burnes</span><span>220 kcal</span>
            </div>
            </motion.div>
        </div>
    </div>
